...
if [ $2 -eq "1" ] ; then
     ...
     echo
     echo INFO automatic selected track from inserted dvd [$AUTO_SELECT_TRACK]
     ...
     if [ -e  ~/.xbmc/userdata/addon_data/script-video-ripper/DVD_SUB ] ; then
         SUB1=$(cat  ~/.xbmc/userdata/addon_data/script-video-ripper/DVD_SUB)
